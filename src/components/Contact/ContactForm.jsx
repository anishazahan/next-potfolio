  ...
  return (
    <div className="  pt-16 pb-32">
      ...
      <div className=" custom-container grid grid-cols-1 gap-4 md:grid-cols-2">
        <div data-aos="fade-right" className="px-6 py-10 md:py-6 mr-4 dark:bg-black/60 bg-gray-900 sm:rounded-md">
          <h1 className="text-3xl sm:text-3xl text-gray-300  font-bold tracking-tight">Get in touch</h1>
          ...
          <div className="flex items-center mt-8 text-gray-300 ">
            ...
            <div className="ml-4 text-md tracking-wide font-semibold w-40">Jashore,Khulna,Bangladesh</div>
          </div>
          ...
          <div className="flex items-center mt-4 text-gray-300 ">
            ...
            <div className="ml-4 text-md tracking-wide font-semibold w-40">+8801979552658</div>
          </div>
          ...
          <div className="flex items-center mt-2 text-gray-300 ">
            ...
            <div className="ml-4 text-md tracking-wide font-semibold w-40">anishazahan13@gmail.com</div>
          </div>
        </div>

        <form onSubmit={handleSubmit(onSubmit)} className="mt-10 lg:px-5 md:px-0">
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="relative z-0">
              ...
              {errors.name && <span className="text-red-500 text-sm text-italic">{errors.name.message}</span>}
            </div>
            <div className="relative z-0">
              <input
                type="text"
            ...
            <div className="relative z-0 col-span-2">
              ...
              {errors.message && <span className="text-red-500 text-sm text-italic">{errors.message.message}</span>}
            </div>
          </div>
          <button
            // data-aos="fade-up"
        ...
        {showPopup && (
          <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
            <div className="bg-black/80 w-[80%] py-20  md:w-[600px]  items-center rounded-md">
              ...
              <p className="text-xl text-slate-200 font-bold mb-4 text-center">Message Send Successfully.</p>

              <p className="text-gray-200 text-center mb-5">Contacted with you shortly</p>

              <div className="flex justify-center space-x-4 items-center mt-8">
                <button className="px-6 py-2 bg-purple-700 text-white rounded-sm font-bold" onClick={handlePopupClose}>
                  Close
                </button>
              </div>
            </div>
