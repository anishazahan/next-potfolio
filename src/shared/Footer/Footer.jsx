...
const Footer = () => {
  return (
    <footer class="bg-gray-900">
      <div class="custom-container px-4 py-16 mx-auto ">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <h2 className="text-gray-300">Logo</h2>
          ...
          <div class="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              <p class="font-semibold uppercase text-gray-300 border-b-2 border-primary inline-block">
                About
              </p>
