    ...
    <>
      <div className="navbar-bg shadow">
        <nav className=" z-10 custom-container py-4 flex justify-between  items-center ">
          ...
          <button
            className="px-4 py-2 rounded dark:bg-gray-700 dark:text-white bg-gray-300 text-black"
            onClick={toggleTheme}
          >
            Toggle Theme
          </button>

          <label className="swap swap-rotate px-6 py-3 rounded-full bg-gray-500">
            <input
              type="checkbox"
              checked={theme === "dark"}
